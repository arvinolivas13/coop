                ...
                <ul class="metismenu" id="menu1">
                    ...
                    <li>
                        ...
                        <ul class="submenu-angle" aria-expanded="false">
                            <li>
                                <a title="Loan Request" href="{{url('loan-request')}}"><span class="mini-sub-pro">Request</span></a>
                            </li>
                            <li>
                                <a title="Loan Schedule" href="{{url('loan-schedule')}}"><span class="mini-sub-pro">Schedule</span></a>
                            </li>
                            <li>
                                <a title="Loan Payment" href="{{url('loan-payment')}}"><span class="mini-sub-pro">Payment</span></a>
                            </li>
                        </ul>
                    </li>
